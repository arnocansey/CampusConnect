    ...
    <div className="max-w-7xl mx-auto p-4">
      ...
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center justify-between mb-6 gap-3">
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">{t('notifications.title')}</h1>
          <Button
            variant="ghost"
            size="sm"
          ...
          <div className="space-y-2">
            {notificationsData?.notifications?.map((notification: Notification) => (
              <div
                ...
                className={`rounded-2xl p-4 border transition cursor-pointer hover:opacity-80 ${
                  notification.isRead
