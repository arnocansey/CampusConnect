    ...
    <div className="max-w-2xl mx-auto p-4">
      <div className="flex items-center justify-between mb-6 gap-3">
        <div className="min-w-0">
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">📅 Campus Events</h1>
          <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm mt-1">Discover what's happening</p>
        </div>
