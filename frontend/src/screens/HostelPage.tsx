  ...
  return (
    <div className="max-w-2xl mx-auto p-4">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">🏠 Hostel Finder</h1>
          <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Find your perfect accommodation</p>
        </div>
