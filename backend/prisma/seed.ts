  ...
  const marketplaceItems = await Promise.all([
    ...
    prisma.marketplaceItem.create({
      data: {
        ...
        description: 'Lasko 12-inch desk fan. Works perfectly, great for hot hostel days. Moving out and need to sell.',
        images: [],
        price: 80,
        currency: 'GHS',
    ...
    prisma.marketplaceItem.create({
      data: {
        ...
        description: 'Offering one-on-one math tutoring for calculus, algebra, and statistics. Patient and experienced. GHS 50/hour.',
        images: [],
        price: 50,
        currency: 'GHS',
        category: 'SERVICES',
  ...
  const notes = await Promise.all([
    ...
    prisma.note.create({
      data: {
        ...
        description: 'Detailed notes on Constitutional Law. Covers fundamental rights, separation of powers, and federalism.',
        ...
        tags: ['Constitutional Law', 'Law', 'LAW201'],
      },
    }),
    prisma.note.create({
      data: {
        title: 'Mass Media and Society - Handout',
        description: 'Complete handout for Mass Media and Society course. Covers media theories, journalism ethics, and media in Ghana.',
  ...
  const jobs = await Promise.all([
    prisma.job.create({
      data: {
        ...
        contactEmail: 'jobs@techstart.com',
      },
    }),
    prisma.job.create({
      data: {
        ...
        contactEmail: 'hr@greenfield.com',
      },
    }),
    prisma.job.create({
      data: {
    ...
    prisma.job.create({
      data: {
        ...
        contactEmail: 'internships@fintech.com',
      },
    }),
    prisma.job.create({
      data: {
        ...
        salary: 'GH₵150 - GH₵500 per project',
        jobType: 'FREELANCE',
        location: 'Remote',
        isRemote: true,
        deadline: new Date('2026-12-31'),
        contactEmail: 'design@creativehub.com',
      },
    }),
  ]);
